...
function getTag(name) {
    ...
    switch (name) {
        ...
        case "twitter_card_image_alt":
            val = '<meta name="twitter:image:alt" content="{ALT_TEXT}" />';
            break;
        ...
        case "twitter_card_site_id":
            val = '<meta name="twitter:site:id" content="{TWITTER_USER_ID}" />';
            break;
        case "twitter_card_creator":
            val = '<meta name="twitter:creator" content="{TWITTER_USERNAME}" />';
            break;
        case "twitter_card_creator_id":
            val = '<meta name="twitter:creator:id" content="{TWITTER_USER_ID}" />';
            break;
